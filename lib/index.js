...
class Instagram {
  constructor(
    ...
    console.log('HI FROM THE CONSTRUCTOR WEEE!!')
  ...
  async getUserByUsername({ username }) {
    console.log('STARTING getUserByUsername() ', username)
    console.log('REQUEST URI: ', `/${username}/?__a=1`)
    return this.request({
      uri: `/${username}/?__a=1`
    }).then(data => {
      console.log('GOT REPLY FROM STUPID FUNCTION ---------------')
      console.log(data)
      console.log('----------------------------------------------')
